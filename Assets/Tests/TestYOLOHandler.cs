...
namespace Tests
{
    public class TestYOLOHandler
    {
        ...
        {
            // given
            Rect firstExpectedRect = new Rect(x: -3.34f, y: 53.32f, width: 229.38f, height: 318.09f);
            Rect secondExpectedRect = new Rect(x:234.16f, y:83.54f, width:94.07f, height:129.21f);
