...
namespace NN
{
    public class YOLOv8SegmentationOutputReader : YOLOv8OutputReader
    {
        protected override ResultBox ReadBox(float[,] array, int box)
        {
            ...
            Tensor masksScoresTensor = new Tensor(1, masksScore.Length, masksScore);

            ResultBoxWithMasksIndices result = new ResultBoxWithMasksIndices(resultBox, masksScoresTensor);
            return result;
        }
